...
view.o: src/view/view.h src/view/view.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/view/view.cpp -o view.o -lncurses


model.o: src/model/model.h src/model/model.cpp wall.o element.o
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/model.cpp -o model.o wall.o element.o -lncurses


none.o: src/model/game-objects/none.h src/model/game-objects/none.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/game-objects/none.cpp -o none.o -lncurses


wall.o: src/model/game-objects/wall.h src/model/game-objects/wall.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/game-objects/wall.cpp -o wall.o -lncurses


pacman.o: src/model/game-objects/pacman.h src/model/game-objects/pacman.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/game-objects/pacman.cpp -o pacman.o -lncurses


monster.o: src/model/game-objects/monster.h src/model/game-objects/monster.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/game-objects/monster.cpp -o monster.o -lncurses


element.o: src/model/game-objects/element.h src/model/game-objects/element.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/game-objects/element.cpp -o element.o -lncurses


coin.o: src/model/game-objects/coin.h src/model/game-objects/coin.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/model/game-objects/coin.cpp -o coin.o -lncurses
...
map.o: src/controller/map.h src/controller/map.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/controller/map.cpp -o map.o -lncurses


gamelow.o: src/controller/gamelow.h src/controller/gamelow.cpp
	g++ -Wall -pedantic -Wno-long-long -O0 -ggdb -c src/controller/gamelow.cpp -o gamelow.o -lncurses
